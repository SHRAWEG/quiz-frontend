...
import { Calendar, Mail, Phone, Shield, Tags, User, Verified } from 'lucide-react'
import { useGetUserPreference, useGetUserProfile } from '@/hooks/api/useUserProfile'
...
export default function ProfilePage() {
  ...
  const { data: preferences, isFetching: isPreferencesLoading } = useGetUserPreference()
