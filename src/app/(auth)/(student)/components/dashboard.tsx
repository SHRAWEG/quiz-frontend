            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <Card>
                    <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-muted-foreground">Question Sets Completed</p>
                                <h3 className="text-2xl font-bold">{data?.completedQuestionSets}</h3>
                            </div>
                ...
                <Card>
                    <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-muted-foreground">Pending Question Sets</p>
                                <h3 className="text-2xl font-bold">{data?.incompleteQuestionSets}%</h3>
                            </div>
